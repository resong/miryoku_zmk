...
&kp Q,             &kp W,             &kp E,             &kp R,             &kp T,             &kp Y,             &kp U,             &kp I,             &kp O,             &kp P,             \
GQT(LGUI, A),      GQT(LALT, S),     GQT(LCTRL, D),    GQT(LSHFT, F),    &kp G,             &kp H,             GQT(LSHFT, J),    GQT(LCTRL, K),    GQT(LALT, L),     GQT(LGUI, SQT),   \
U_LT(U_BUTTON, Z), U_MT(RALT, X),     &kp C,             &kp V,             &kp B,             &kp N,             &kp M,             &kp COMMA,         U_MT(RALT, DOT),   U_LT(U_BUTTON, SLASH),\
U_NP,              U_NP,              U_LT(U_MEDIA, ESC),U_LT(U_NAV, RET),  U_LT(U_MOUSE, BSPC),U_LT(U_SYM, DEL),  U_LT(U_NUM, SPC), U_LT(U_FUN, TAB),  U_NP,              U_NP
...
&kp LGUI,          &kp LALT,          &kp LCTRL,         &kp LSHFT,         &kp EQL,           &kp PLUS,          &kp RSHFT,         &kp RCTRL,         &kp RALT,          &kp RGUI,          \
&kp GRAVE,         &kp SEMI,          &kp UNDER,         &kp LBKT,          &kp LBRC,          &kp RBRC,          &kp RBKT,          &kp MINUS,         &kp COLON,         U_NA,              \
U_NP,              U_NP,              &kp DOT,           &kp LPAR,          &kp BSLH,          &kp FSLH,              U_NA,          &kp RPAR,          U_NP,              U_NP
...
&kp EXCL,          &kp AT,            &kp HASH,          &kp DLLR,          &kp PRCT,          &kp CRRT,          &kp AMPS,          &kp ASTRK,         &kp LPAR,          &kp RPAR,          \
&kp COLON,         &kp DLLR,          &kp GRAVE,         &kp SEMI,          &kp COLON,         &kp MINUS,              &kp LSHFT,         &kp LCTRL,         &kp LALT,          &kp LGUI,          \
&kp TILDE,         &kp EXCL,          &kp AT,            &kp TILDE,         &kp PIPE,          U_NA,              &u_to_U_SYM,       &u_to_U_MOUSE,     &kp RALT,          U_NA,              \
